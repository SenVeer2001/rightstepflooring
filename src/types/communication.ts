...
export type ChatType = 'client' | 'team' | 'request';
...
export interface RelatedEntity {
  id: string;
  type: 'job' | 'estimate' | 'invoice' | 'work_order' | 'customer' | 'lead';
  title: string;
  subtitle?: string;
  status?: string;
...
export interface Message {
  ...
  attachments?: Attachment[];
  isStarred?: boolean;
  // For notification type messages
...
export type NavTab = 'all' | 'requests' | 'clients' | 'team' | 'archived';