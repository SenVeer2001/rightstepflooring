...
const monthlyTrendData = [
    { month: "Aug", toBePaid: 45000, paid: 38000, hold: 4500, cancelled: 2500, rstEarnings: 12500 },
    { month: "Sep", toBePaid: 52000, paid: 45000, hold: 5200, cancelled: 1800, rstEarnings: 14800 },
    { month: "Oct", toBePaid: 48000, paid: 42000, hold: 4800, cancelled: 1200, rstEarnings: 13200 },
    { month: "Nov", toBePaid: 61000, paid: 55000, hold: 4500, cancelled: 1500, rstEarnings: 17500 },
    { month: "Dec", toBePaid: 58000, paid: 50000, hold: 5800, cancelled: 2200, rstEarnings: 16200 },
    { month: "Jan", toBePaid: 76950, paid: 40865, hold: 31310, cancelled: 4775, rstEarnings: 21500 },
]
    ...
    return (
        <div className="space-y-6 p-4">
                                ...
                                <div className="grid grid-cols-3 gap-2 mb-4">
                                    {months.map((month, index) => (
                                        <button
                                            ...
                                            className={`px-3 py-2 text-sm rounded-lg transition ${index === selectedMonth
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                {/* Trend Chart */}
                {/* Payment Trends with RST Earnings */}
                <div className="lg:col-span-2 bg-white rounded-xl border p-5 shadow-sm">
                    <div className="flex items-center justify-between mb-4">
                        <div>
                            <h3 className="font-semibold text-gray-900">Payment Trends & RST Earnings</h3>
                        ...
                        <div className="flex items-center gap-4">
                            <div className="flex items-center gap-2 px-3 py-1.5 bg-emerald-50 rounded-lg border border-emerald-200">
                                ...
                                <span className="text-xs font-semibold text-emerald-700">
                                    Total Earnings: ${monthlyTrendData.reduce((sum, m) => sum + m.rstEarnings, 0).toLocaleString()}
                                </span>
                            </div>
                    ...
                    <div className="flex flex-wrap items-center gap-4 mb-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs text-gray-600">Paid to Subcontractors</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <div className="w-3 h-3 rounded-full bg-[#EDD464]"></div>
                            <span className="text-xs text-gray-600">RST Earnings (Profit)</span>
                        </div>
                    </div>
                            ...
                            <AreaChart data={monthlyTrendData}>
                                <defs>
                                    ...
                                    <linearGradient id="colorEarnings" x1="0" y1="0" x2="0" y2="1">
                                        <stop offset="5%" stopColor="#EDD464" stopOpacity={0.4} />
                                        <stop offset="95%" stopColor="#EDD464" stopOpacity={0.05} />
                                    </linearGradient>
                                </defs>
